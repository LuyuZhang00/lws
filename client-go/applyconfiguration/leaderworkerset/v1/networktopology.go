...
func (b *NetworkTopologyApplyConfiguration) WithMode(value string) *NetworkTopologyApplyConfiguration {
	b.Mode = &value
	return b
}
...
func (b *NetworkTopologyApplyConfiguration) WithHighestTierAllowed(value int) *NetworkTopologyApplyConfiguration {
